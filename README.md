...
- [Example 2 - Changing the DOM with JavaScript](https://github.com/philhawksworth/fcc-2-adding-js-for-simple-render)
- [Example 3 - Introducing a static site generator](https://github.com/philhawksworth/fcc-3-build-with-ssg)
- [Example 4 - Generating pages from a content API](https://github.com/philhawksworth/fcc-4-build-with-api-data)
